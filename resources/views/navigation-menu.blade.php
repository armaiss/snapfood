...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center ml-3">
                    <a href="{{ route('dashboard') }}">
                        <!-- افزایش اندازه لگو به دوبرابر -->
                        <img src="https://tadbirsara.com/wp-content/uploads/2017/11/08.jpg" alt="نام لگو" class="block h-14 w-auto"/>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->hasRole('admin'))
                        ...
                        <x-nav-link href="{{ route('restaurantCategories.index') }}"
                                    :active="request()->routeIs('dashboard')">
                    ...
                    @if(Auth::user()->hasRole('shop_manager') )
                        <x-nav-link
                            href="{{ route('restaurants.edit',\Illuminate\Support\Facades\Auth::user()->restaurant ) }}"
                            :active="request()->routeIs('dashboard')">
                            {{'مدیریت رستوران'}}
                        </x-nav-link>
                    @endif
    ...
    <image href="https://snappfood.ir/static/images/hero-image.png" height="24" width="24"/>
