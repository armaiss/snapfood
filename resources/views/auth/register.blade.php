<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="phone_number" value="{{ __('َشماره تماس') }}" />
                <x-input id="phone_number" class="block mt-1 w-full" type="text" name="phone_number" :value="old('email')" required autocomplete="username" />
            </div>
            ...
            <div class="flex items-center justify-between mt-4">
                <a class=" text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-3 focus:ring-offset-2 focus:ring-blue-300 href="{{ route('login') }}">
